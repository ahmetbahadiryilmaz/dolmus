...
$id =$_GET["id"];
include ("inc/db.php");
$query = db::$conn->query("SELECT * FROM tb_plaka where id = '{$id}' and _deleted=0", PDO::FETCH_ASSOC);
if ( $query->rowCount() ){
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Plaka Düzenle</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="plaka-listele.php">Plaka Listesi</a></li>
              <li class="breadcrumb-item active">Plaka Düzenle</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <form id="plaka" method="Post">
          <div class="card card-outline card-info">
                  <div class="card-header">
                      <h3 class="card-title">Plaka Düzenle</h3>
                          ...
                          <?php
                              ...
                              if ( $turler->rowCount() ){
                                  foreach( $turler as $row ){
                                        ...
                                        $adi= $row['adi'];
                                      ?>
                                        <option value="<?=$turid?>" <?php echo $tur_id==$turid? "selected" : "";?>><?=$adi?></option>
