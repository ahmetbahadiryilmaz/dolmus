...
$id =$_GET["id"];
include ("inc/db.php");
$query = db::$conn->query("SELECT * FROM tb_kullanici where id = '{$id}' and _deleted=0", PDO::FETCH_ASSOC);
if ( $query->rowCount() ){
          ...
          <div class="card card-outline card-info">
                  ...
                  <div class="card-body">
                          <div class="form-group">
                              ...
                              <input type="text"  id="isim" name="isim" value="<?php echo $isim;?>" class="form-control">
                          </div>    
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <select id="yetki" name="yetki" class="form-control select2bs4" style="width: 100%;">
                                    <option  <?php echo $yetki == "Bilinmiyor" ? "selected" : ""; ?> value="Bilinmiyor">Bilinmiyor</option>
                                    <option  <?php echo $yetki == "Yönetici" ? "selected" : ""; ?> value="Yönetici">Yönetici</option>
                                    <option  <?php echo $yetki == "Admin" ? "selected" : ""; ?> value="Admin">Admin</option>
                              </select>
                          </div>         
                  </div>
                  <!-- /.card-body -->
...
$(document).ready(function() {
    $('#kullanici').submit(function(e) {
        ...
        $.ajax({
            type: "POST",
            url: 'ajax/kullanici-duzenle.php',
            data: $(this).serialize(),
