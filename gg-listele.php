...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Gelir/Gider Listesi</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Ana sayfa</a></li>
              <li class="breadcrumb-item active">Gelir/Gider Listesi</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                <a href="gg-ekle.php" class="btn btn-success">
                  Yeni
                </a>
        ...
        $('#example1').DataTable({
            ...
            'columns': [
              ...
              { data: 'tarih' },
              {
                ...
                {
                  return '<a href="gg-duzenle.php?id=' + row.id +'" class="btn btn-info" style="width:100px;">Düzenle</a> <a href="" data-id="' + row.id +'" class="delete btn btn-danger" style="width:100px;">Sil</a>';
                }
              }
            ],		
            "order": [[ 0, "desc" ]],
                ...
                {              
                  const Toast = Swal.mixin({
                    ...
                    if (jsonData.success == "1")
                    {
                      ...
                      setTimeout("location.href = 'gg-listele.php'",1500);
                    }
                    else
                    {
                      Toast.fire({
